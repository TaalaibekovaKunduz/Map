...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Song song1 = new Song("Истерика ", "Карина Кросс");
            Song song2 = new Song("Акыркы кат ", "Баястан");
            Song song3 = new Song("Шейхами ", "Газан");
            Song song4 = new Song("Mad Love", "Извиняюсь я забыла имя автора");
            Song song5 = new Song("Кыш ", "Баястан");
